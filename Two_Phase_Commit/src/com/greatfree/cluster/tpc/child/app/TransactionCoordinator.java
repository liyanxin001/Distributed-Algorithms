...
public class TransactionCoordinator {
    ...
    public void addParticipant(DatabaseParticipant participant) {
    ...
    public boolean executeDistributedTransaction() {
        ...
        List<DatabaseParticipant> preparedParticipants = new ArrayList<>();
        boolean allVotesYes = true;

        for (DatabaseParticipant p : participants) {
